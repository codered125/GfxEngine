...
public:
	RenderTexture();
	RenderTexture(GLuint InWidth, GLuint InHeight, GLuint InDepth, GLenum InTargetType, GLenum InInternalFormat, GLenum InFormat, bool InMSAA, GLenum InMinFilter, GLenum InMagFilter, GLenum InWrap, const void* InPixels, GLenum InBufferType, std::function<void()> InPreParamInitalizerFunction);
