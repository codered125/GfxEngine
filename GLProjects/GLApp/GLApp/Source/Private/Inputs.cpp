...
void Input::InitializeInputMap(std::map<int, int> & InputMap)
{
...
void Input::KeyCallback(GLFWwindow * window, int key, int scancode, int action, int mode, Camera * Cam, bool KeyRef[])
{
